...
import cc.vcode.util.SystemTime;
import cc.vcode.torrent.TOTorrent;
import cc.vcode.torrent.TOTorrentException;
import cc.vcode.torrent.TOTorrentProgressListener;
...
public class TOTorrentCreateImpl extends TOTorrentImpl implements TOTorrentFileHasherListener
{
	...
	public TOTorrentCreateImpl(File _torrent_base, URL _announce_url, boolean _add_other_hashes, long _piece_length, TOTorrentProgressListener _progress_listener)
	...
	public TOTorrentCreateImpl(File _torrent_base, URL _announce_url, boolean _add_other_hashes, long _piece_min_size, long _piece_max_size, long _piece_num_lower, long _piece_num_upper, TOTorrentProgressListener _progress_listener)
	...
	throws TOTorrentException
	{
		...
		TOTorrentFileHasher hasher = new TOTorrentFileHasher(add_other_hashes, add_other_per_file_hashes, (int) _piece_length, progress_listener == null ? null : this);
	...
	protected void processDir(TOTorrentFileHasher hasher, File dir, Vector<TOTorrentFileImpl> encoded, String root)
	...
	protected long calculateNumberOfPieces(File file, long piece_length)
	...
	protected void setIgnoreList()
	{
		...
		String ignore_list = TOTorrent.DEFAULT_IGNORE_FILES;
