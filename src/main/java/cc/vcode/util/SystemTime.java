...
public class SystemTime
{
	...
	/**
	 * Check if there has been a time error (time went backwards) within the last 1 second.
	 * 
	...
	/**
	 * Check if there has been a time error (time went backwards) within the last 5 seconds.
	 * 
	 * @return true if there has been an error, false if everything is normal
	 */
	...
	/**
	 * Check if there has been a time error (time went backwards) within the last 10 seconds.
	 * 
	 * @return true if there has been an error, false if everything is normal
	 */
	...
	/**
	 * Check if there has been a time error (time went backwards) within the last 30 seconds.
	 * 
	 * @return true if there has been an error, false if everything is normal
	 */
	...
	/**
	 * Check if there has been a time error (time went backwards) within the last 1 minute.
	 * 
	 * @return true if there has been an error, false if everything is normal
	 */
	...
	/**
	 * Check if there has been a time error (time went backwards) within the last 5 minutes.
	 * 
	 * @return true if there has been an error, false if everything is normal
	 */
	...
	/**
	 * Check if there has been a time error (time went backwards) within the last 10 minutes.
	 * 
	 * @return true if there has been an error, false if everything is normal
	 */
